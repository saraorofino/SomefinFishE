...
results_rep10c_edit <- results_rep10c %>% 
  mutate(ratio_cat = case_when(results_rep10c$V7 <= 1 ~ 0,
                               results_rep10c$V7 > 1 & results_rep10c$V7 < 2 ~ 1,
                               results_rep10c$V7 > 2 ~ 2)) %>% 
  mutate(ratio_err_cat = case_when(results_rep10c$V8 <= 1 ~ 0,
                               results_rep10c$V8 > 1 & results_rep10c$V8 < 2 ~ 1,
                               results_rep10c$V8 > 2 ~ 2)) %>%
...
#           file=file.path(here(),"/Results/error/rep10_constant.csv"),
#           row.names = FALSE)

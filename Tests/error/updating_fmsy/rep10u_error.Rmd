...
Experiment: Simulate an initial stock assessment in Year 1 with varied amounts of error around the estimate of f/fmsy. Make a decision on the harvest control rule based on the estimate of f/fmsy. Apply that rule to the fishing mortality in that year. Repeat this process every 10 years, applying the change in f to that year.This model includes a decrease in productivity over time due to climate change (r_s term).

Assumptions:
 - The perceived Fmsy is updating (ie the managers are updating their estimates of Fmsy during an assessment year to reflect changes in productivity)

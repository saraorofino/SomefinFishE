...
results_rep5u_edit <- results_rep5u %>%
  mutate(ratio_cat = case_when(results_rep5u$V7 <= 1 ~ 0,
                               results_rep5u$V7 > 1 & results_rep5u$V7 < 2 ~ 1,
                               results_rep5u$V7 > 2 ~ 2)) %>% 
  mutate(ratio_err_cat = case_when(results_rep5u$V8 <= 1 ~ 0,
                               results_rep5u$V8 > 1 & results_rep5u$V8 < 2 ~ 1,
                               results_rep5u$V8 > 2 ~ 2)) %>%
...
#           file=file.path(here(),"/Results/error/rep5_updating.csv"),
#           row.names = FALSE)

...
check_result_msy5u <- sim_msy5u(b=6000, r=0.2, r_s=-0.01767, error=0.1, p=0.2, k=10000, years=100)
```
...
results_msy5u_edit <- results_msy5u %>%
  mutate(ratio_cat = case_when(results_msy5u$V7 <= 1 ~ 0,
                               results_msy5u$V7 > 1 & results_msy5u$V7 < 2 ~ 1,
                               results_msy5u$V7 > 2 ~ 2)) %>% 
  mutate(ratio_err_cat = case_when(results_msy5u$V8 <= 1 ~ 0,
                               results_msy5u$V8 > 1 & results_msy5u$V8 < 2 ~ 1,
                               results_msy5u$V8 > 2 ~ 2)) %>%

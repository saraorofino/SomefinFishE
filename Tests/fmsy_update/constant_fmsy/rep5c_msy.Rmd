...
check_result_msy5c <- sim_msy5c(b=6000, r=0.2, r_s=-0.01767, error=0.1, p=0.2, k=10000, years=100)
```
...
results_msy5c_edit <- results_msy5c %>%
  mutate(ratio_cat = case_when(results_msy5c$V7 <= 1 ~ 0,
                               results_msy5c$V7 > 1 & results_msy5c$V7 < 2 ~ 1,
                               results_msy5c$V7 > 2 ~ 2)) %>% 
  mutate(ratio_err_cat = case_when(results_msy5c$V8 <= 1 ~ 0,
                               results_msy5c$V8 > 1 & results_msy5c$V8 < 2 ~ 1,
                               results_msy5c$V8 > 2 ~ 2)) %>%
...
#            file=file.path(here(),"/Results/fmsy_update/msy_rep5_constant.csv"),
#            row.names = FALSE)

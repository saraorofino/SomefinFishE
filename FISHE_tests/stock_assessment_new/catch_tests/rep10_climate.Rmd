...
Goal: Simulate the initial use of FISHE, if it is only applied on 10 year intervals, focusing on the Inital Stock Assessment step of the process, with climate change reducing productivity. 
...
check_result_10c <- sim_10(b=6000, r=0.2, r_s=-0.005, error=0.10, p=0.2, k=10000, years=100)
```
...
colnames(results_rep10c) <- col_names

#Write as CSV:
library(here)
write.csv(results_rep10c, file=file.path(here(),"/FISHE_tests/stock_assessment_new/catch_tests/csv_results/rep10_clim.csv"),
          row.names = FALSE)

...
11.20 SO: Commented this whole chunk out (command+shift+C) to avoid confusion. Testing a new model using error around the f/fmsy ratio in code chunk 8 (model-fratio-error)
```{r model}

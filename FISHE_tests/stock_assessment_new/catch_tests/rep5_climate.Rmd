...
colnames(results_rep5c) <- col_names

#Write as CSV:
library(here)
write.csv(results_rep5c, file=file.path(here(),"/FISHE_tests/stock_assessment_new/catch_tests/csv_results/rep5_clim.csv"),
          row.names = FALSE)

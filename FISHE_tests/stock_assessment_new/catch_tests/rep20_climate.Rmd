...
check_result_20 <- sim_20c(b=6000, r=0.2, r_s=-0.005, error=0.10, p=0.2, k=10000, years=100)
```
...
col_names <- c("b", "c", "year", "r", "f", "f_msy", "f_ratio", "f_ratio_err", "id")
...
colnames(results_rep20c) <- col_names

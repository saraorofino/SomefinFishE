...
check_result_15c <- sim_15c(b=6000, r=0.2, r_s=-0.005, error=0.10, p=0.2, k=10000, years=100)
```
...
colnames(results_rep15c) <- col_names

#Write as CSV:
library(here)
write.csv(results_rep15c, file=file.path(here(),"/FISHE_tests/stock_assessment_new/catch_tests/csv_results/rep15_clim.csv"),
          row.names = FALSE)

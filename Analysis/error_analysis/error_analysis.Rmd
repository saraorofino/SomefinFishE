...
#Change r_0 into three categories - slow, intermediate, and fast
rep5u_fail <- rep5u %>% 
...
rep5u_fail$r_s <- as.factor(rep5u_fail$r_s)
...
fail5 <- ggplot(rep5u_fail, aes(x = error, y= prop_5u)) +
